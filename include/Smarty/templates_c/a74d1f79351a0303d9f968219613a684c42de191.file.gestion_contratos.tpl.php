<?php /* Smarty version Smarty-3.1.19, created on 2015-11-03 22:45:06
         compiled from ".\views\gestion_contratos.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7184561429fe52f126-25031704%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a74d1f79351a0303d9f968219613a684c42de191' => 
    array (
  ...
  'nocache_hash' => '7184561429fe52f126-25031704',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_561429fe5ee7a1_13042405',
  'variables' => 
  array (
    'cuantos_contratos' => 0,
    'i' => 0,
...
<?php if ($_valid && !is_callable('content_561429fe5ee7a1_13042405')) {function content_561429fe5ee7a1_13042405($_smarty_tpl) {?><table class="tabla_contratos">
<tr>
                        ...
                        <tr id="si_garantia_tr">
                            <td colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td><textarea id="diagnostico_cliente" name="diagnostico_cliente" cols="23" rows="2" class="text ui-widget-content ui-corner-all" required ></textarea></td>
                                </tr>                                
                                <tr>
...
<div id="dialog-contrato-pagar" title="Pagar PPTO Contrato">
	<form id="pagar_contrato_frm" name="pagar_contrato_frm" method="post" action="" class="ui-front">
        ...
        <tr>
        	<th>Num. Boleta</th>
            <td><input type="text" id="boleta_contrato" name="boleta_contrato" class="text ui-widget-content ui-corner-all" /></td>
        </tr>
