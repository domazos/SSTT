<?php /* Smarty version Smarty-3.1.19, created on 2015-11-03 16:07:56
         compiled from ".\views\vb_cliente.tpl" */ ?>
<?php /*%%SmartyHeaderCode:205935637c65f7d7d83-68160062%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '069a8347f8fae8b173c1be246135413f0d62f99d' => 
    array (
  ...
  'nocache_hash' => '205935637c65f7d7d83-68160062',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5637c65f8be507_02607341',
  'variables' => 
  array (
    'id_contrato' => 0,
    'info' => 0,
...
<?php if ($_valid && !is_callable('content_5637c65f8be507_02607341')) {function content_5637c65f8be507_02607341($_smarty_tpl) {?><script>
...
$(document).ready(function(e) {
    $('.submit').on('click', function()
	{
		...
		if(id == 'acepta_ppto')
		{
			$.post('./include/vb_cliente.php', { accion: 'acepta', i: $('#i').val() }, function(data)
			{
...
" class="text ui-widget-content ui-corner-all" readonly="readonly" /></td>
                ...
                <div id="lista_repuestos" style="margin:0 auto; <?php if ($_smarty_tpl->tpl_vars['info']->value['aplica_garantia']==1) {?> width:60%; <?php } else { ?> width:90%; <?php }?>">
                    <table class="nuevo_usuario">
                    <tr>
                        <td>
